...
class Settings extends Component {
  ...
  renderEmailSection() {
    ...
    if (!emailStep) {
      return (
        <Fragment>
          <div className="flex flex-col max-w-xs gap-2 mt-10 mb-5">
    ...
    return (
      <Card className="mt-4 h-full flex-1 min-h-0">
        ...
        <CardBody className="overflow-scroll padding-tracker">
          <div>
            <form className="flex flex-col gap-5 max-w-xs" method="POST" action="" onSubmit={this.submit}>
            ...
            <div className="flex gap-2 mt-10" onClick={this.toggleTwoFA}>
              {twoFA_login ? (
