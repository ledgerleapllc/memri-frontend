...
class SingleChangeDetail extends Component {
  ...
  forceDenyChange = (e) => {
    e.preventDefault();
    if (
      !window.window.confirm("Are you sure you are going to force deny this proposed change?")
    )
      return;
  ...
  forChange = (e) => {
    e.preventDefault();
    if (
      !window.confirm("Are you sure you are going to support UP this proposed change?")
    )
      return;
  ...
  approveChange = (e) => {
    e.preventDefault();
    if (!window.confirm("Are you sure you are going to approve this proposed change?"))
      return;
  ...
  denyChange = (e) => {
    e.preventDefault();
    if (!window.confirm("Are you sure you are going to deny this proposed change?"))
      return;
  ...
  withdrawChange = (e) => {
    e.preventDefault();
    if (
      !window.confirm("Are you sure you are going to withdraw this proposed change?")
    )
      return;
